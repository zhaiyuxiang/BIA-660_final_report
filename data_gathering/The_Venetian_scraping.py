...
url_1='https://www.booking.com/reviews/us/hotel/the-venetian-resort-casino.html?aid=304142;label=gen173nr-1FCAEoggJCAlhYSDNYBHIFdXNfbmqIAQGYATHCAQp3aW5kb3dzIDEwyAEM2AEB6AEB-AECkgIBeagCAw;sid=b88de736b1557b87baaeffc576661734;customer_type=total;hp_nav=0;old_page=0;order=featuredreviews;page='
url_2=';r_lang=en;rows=75&'
page_number=1
data = []
neg_data=[]
pos_data=[]
while page_number<=46:
...
df_over.to_csv(r'C:\Users\yuxia\Desktop\booking_data\Venetian_overall_data.csv')
df_pos.to_csv(r'C:\Users\yuxia\Desktop\booking_data\Venetian_pos_reviews.csv')
df_neg.to_csv(r'C:\Users\yuxia\Desktop\booking_data\Venetian_neg_reviews.csv')
